...
- [ ]  Spatial Transformer Networks performs spatial transformations on images or feature maps with a (sub-)differentiable module. What mean by sub-differentiable?
- [x] 跑通[demormable networks官版](https://github.com/msracver/Deformable-ConvNets).将配好的环境存成[docker](https://www.docker.com) image以便交流
